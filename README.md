# matrix-appservice-wechaty [![[M] Chat](https://img.shields.io/matrix/matrix-appservice-wechaty:matrix.org?label=%5BM%5D%20Chat)](https://matrix.to/#/#matrix-appservice-wechaty:matrix.org)
